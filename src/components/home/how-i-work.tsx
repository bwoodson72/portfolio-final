...
export const HowIWork = () => {
  ...
  return (
    <section id="about" className="mx-auto w-full max-w-7xl px-6 py-24 border-t border-(--color-border)">
      <div className="grid gap-12 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <Link
            href="/about"
            className="inline-block text-sm font-bold text-(--color-text) hover:underline underline-offset-4"
          >
            More about me →
          </Link>
        </div>
        ...
        <div className="space-y-6">
          <h3 className="text-xs font-bold uppercase tracking-widest text-(--color-text-muted)">Primary Stack</h3>
